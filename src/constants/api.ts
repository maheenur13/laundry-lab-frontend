...
const API_URL_PROD = extra.apiUrlProd || 'https://laundry-lab-backend.onrender.com/api/v1';
const API_URL_ANDROID_EMU = extra.apiUrlAndroidEmu || 'http://10.0.2.2:3000/api/v1';
