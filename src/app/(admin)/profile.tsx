...
/**
 * Admin profile screen - Professional design.
 */
export default function AdminProfileScreen() {
  ...
  const handleLogout = () => {
    Alert.alert(t('auth.logout'), 'Are you sure you want to logout?', [
      ...
      { text: t('auth.logout'), style: 'destructive', onPress: () => logoutMutation.mutate() },
    ]);
  };
      ...
      >
        ...
        <Card style={styles.userCard}>
          <View style={styles.avatarContainer}>
            <View style={styles.avatar}>
              <IconShieldCheck size={32} color={colors.primary[600]} strokeWidth={1.5} />
            </View>
          </View>
          <Text style={styles.userName}>{user?.fullName}</Text>
          <View style={styles.roleTag}>
            <IconShieldCheck size={14} color={colors.primary[700]} strokeWidth={1.5} />
        ...
        <Card style={styles.menuCard} padding="none">
          ...
          <Pressable
            ...
            onPress={() => Alert.alert('LaundryBD Admin', 'Version 1.0.0')}
          >
            <View style={styles.menuItemLeft}>
              <View style={styles.menuIconContainer}>
